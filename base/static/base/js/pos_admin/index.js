function getCookie(name) {
 ...
 // Modificación para redirigir a la vista empresaDetail
 $(document).on("click", ".card", function() {
     var empresaId = $(this).data('id'); // Obtener el ID de la empresa
     window.location.href = `/empresa/${empresaId}/detalle/`; // Redirigir a la vista detalle
 });
